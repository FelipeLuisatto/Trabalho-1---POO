 ...
 * @author Gabriel
 */
@WebServlet(urlPatterns = {"/juros_simples.html"})
public class Juros_Simples extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1 class='titulo'>Calculadora Juros Simples</h1>");
            
            out.println("<form class='titulo' action='resul_simples.html'>");
            
                out.println("<label>Capital: </label><br>");
                out.println("<input type='text' name='c' placeholder='Insira o Capital Inicial: '><br>");
                out.println("<label>Taxa mensal: </label><br>");
                out.println("<input type='text' name='i' placeholder='Insira a Taxa Mensal: '><br>");
                out.println("<label>Meses: </label><br>");
                out.println("<input type='text' name='t' placeholder='Insira o Tempo: (meses)'><br><br>");
